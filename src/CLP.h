...
// CLP.h
// 
// Modified from CLP.h from Trager's Madeline project.
//
...
private:
	...
	void _setSwitchArguments(std::string currentSwitch,unsigned int argc,char* argv[],int& currentIndex,CLS& cls);
